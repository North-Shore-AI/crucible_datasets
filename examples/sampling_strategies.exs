...
{:ok, full_dataset} = CrucibleDatasets.load(:mmlu_stem, sample_size: 200)
...
{:ok, random_sample} = CrucibleDatasets.random_sample(full_dataset, size: 50, seed: 42)
...
{:ok, stratified_sample} =
  CrucibleDatasets.stratified_sample(
    full_dataset,
    size: 50,
...
{:ok, {train, test}} =
  CrucibleDatasets.train_test_split(
    full_dataset,
    test_size: 0.2,
    shuffle: true,
    seed: 42
...
{:ok, sample1} = CrucibleDatasets.random_sample(full_dataset, size: 30, seed: 12345)
{:ok, sample2} = CrucibleDatasets.random_sample(full_dataset, size: 30, seed: 12345)

# Create sample with different seed
{:ok, sample3} = CrucibleDatasets.random_sample(full_dataset, size: 30, seed: 67890)
