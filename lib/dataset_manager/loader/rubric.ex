defmodule CrucibleDatasets.Loader.Rubric do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, dataset} = CrucibleDatasets.Loader.Rubric.load(:feedback_collection)

      # Load with sample size
      {:ok, dataset} = CrucibleDatasets.Loader.Rubric.load(:feedback_collection, sample_size: 500)
