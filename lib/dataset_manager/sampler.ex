defmodule CrucibleDatasets.Sampler do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, dataset} = CrucibleDatasets.Loader.load(:mmlu)
      {:ok, sample} = CrucibleDatasets.Sampler.random(dataset, size: 200)
  ...
  ## Examples
      ...
      {:ok, sample} = CrucibleDatasets.Sampler.stratified(dataset,
        size: 200,
  ...
  ## Examples
      ...
      {:ok, {train, test}} = CrucibleDatasets.Sampler.train_test_split(
        dataset,
        test_size: 0.2,
        shuffle: true
      )
