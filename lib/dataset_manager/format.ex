defmodule CrucibleDatasets.Format do
  ...
  - `CrucibleDatasets.Format.JSONL` - JSON Lines format
  - `CrucibleDatasets.Format.JSON` - JSON format
  - `CrucibleDatasets.Format.CSV` - CSV format
  - `CrucibleDatasets.Format.Parquet` - Parquet format (via Explorer)
  ...
  def parser_for(:jsonl), do: CrucibleDatasets.Format.JSONL
  def parser_for(:json), do: CrucibleDatasets.Format.JSON
  def parser_for(:csv), do: CrucibleDatasets.Format.CSV
  def parser_for(:parquet), do: CrucibleDatasets.Format.Parquet
  ...
  defp do_parse(path, :jsonl), do: CrucibleDatasets.Format.JSONL.parse(path)
  defp do_parse(path, :json), do: CrucibleDatasets.Format.JSON.parse(path)
  defp do_parse(path, :csv), do: CrucibleDatasets.Format.CSV.parse(path)
  defp do_parse(path, :parquet), do: CrucibleDatasets.Format.Parquet.parse(path)
