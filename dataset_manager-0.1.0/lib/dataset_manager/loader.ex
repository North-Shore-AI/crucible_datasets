defmodule DatasetManager.Loader do
  @moduledoc """
  ...
  alias DatasetManager.{Cache, Dataset}
  alias DatasetManager.Loader.{MMLU, HumanEval, GSM8K}
  ...
  ## Examples
      ...
      iex> DatasetManager.Loader.load(:mmlu_stem)
      {:ok, %Dataset{name: "mmlu_stem", items: [...], ...}}

      iex> DatasetManager.Loader.load(:humaneval, sample_size: 50)
      {:ok, %Dataset{name: "humaneval", items: [50 items], ...}}

      iex> DatasetManager.Loader.load("custom", source: "path/to/data.jsonl")
