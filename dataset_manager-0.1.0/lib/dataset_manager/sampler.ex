defmodule DatasetManager.Sampler do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, dataset} = DatasetManager.Loader.load(:mmlu)
      {:ok, sample} = DatasetManager.Sampler.random(dataset, size: 200)
  ...
  ## Examples
      ...
      {:ok, sample} = DatasetManager.Sampler.stratified(dataset,
        size: 200,
  ...
  ## Examples
      ...
      {:ok, folds} = DatasetManager.Sampler.k_fold(dataset, k: 5)
  ...
  ## Examples
      ...
      {:ok, {train, test}} = DatasetManager.Sampler.train_test_split(
        dataset,
        test_size: 0.2,
        shuffle: true
      )
