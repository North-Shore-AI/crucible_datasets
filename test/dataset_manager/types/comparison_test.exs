defmodule CrucibleDatasets.Types.ComparisonTest do
  ...
  describe "from_hh_rlhf/1" do
    test "parses HH-RLHF format" do
      ...
      assert is_struct(comp.response_a, CrucibleDatasets.Types.Conversation)
    end
...
defmodule CrucibleDatasets.Types.LabeledComparisonTest do
  use ExUnit.Case, async: true
